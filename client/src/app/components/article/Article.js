  ...
  return (
    <div className="article-wrapper">
      ...
      <div className="header-container">
        <label>{title.toUpperCase() || 'ARTICLES'}</label>
        {
          enableCreateItem && <a onClick={handleCreateItem}>Create New Article</a>
        }
      </div>
      ...
      {enableLoadMore && <button onClick={handleLoadMore}>LOAD MORE</button>}
    </div>
  );
}
